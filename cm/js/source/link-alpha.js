(function() {
	...
	var dataTableAddRow = function(row) {
		return "<tr id=\""+row.id+"\">" +
					...
					"<td class=\"cell-tbody\">"+$.maxChar(60, row.titulo)+"</td>" +
					"<td class=\"cell-tbody\">"+$.maxChar(60, row.conteudo)+"</td>" +
	...
	$("table.data-grid > tbody > tr").live("click", function(){
		...
		$("#titulo").attr("value", json.titulo);
		$("#conteudo").attr("value", json.conteudo);
